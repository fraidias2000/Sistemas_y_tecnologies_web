...
@Singleton
@ServerEndpoint("/wsmTempCocidos") 
public class WebSocketManagerCocidos {

    @EJB TempCocidosBean tempCargaCocidos;
    ...
    public void onOpen(Session _session){
        ...
        if (tempCargaCocidos.isCargaCocidosOn()){
            broadcastMsg("cargarCocidos");
        }else{
            broadcastMsg("pararCargaCocidos");
        }
    }
    ...
    public void onMessage(String _message, Session _session){
       System.out.println("======== MSG RX: "+_message);
        switch (_message){
            case "iniciarCargaCocidos":
                tempCargaCocidos.setNivelTempCocidos(INICIO_TEMP);
                tempCargaCocidos.setCargaCocidosOn(true);
                break;
                        
            case "pararCargaCocidos":
                tempCargaCocidos.setNivelTempCocidos(FIN_TEMP);
                tempCargaCocidos.setCargaCocidosOn(false);
                break;  
       }
    }
    ...
    public void destroy(){
        System.out.println("xxx WebSockerManagerCocidos says Bye! ---------------");
    ...
    public void broadcastValorNumerico(String _temp, String _v){
        try {
            ...
            Logger.getLogger(WebSocketManagerCocidos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
